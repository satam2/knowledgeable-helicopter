"""Receipt date normalization for the frozen monthly ARR information test."""
import lightgbm
import hashlib
...
def main():
    ...
    frozen.OUT = frozen.ROOT / 'private_runs/breakthrough_20260916/retrospective_models/monthly_arrival_v2'
