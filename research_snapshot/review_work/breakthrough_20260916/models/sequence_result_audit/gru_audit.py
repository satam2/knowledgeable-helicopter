...
def main():
    ...
    for fold, month, nextmonth in [('F1', '07', '08'), ('F3', '11', '12')]:
        ...
        for variant in ('static', 'context'):
            ...
            assert rec['source_hashes'] == protocol['source_hashes'] and rec['split'] == split
            ...
            result = {'status': 'passed', 'score_rows': len(saved), 'replay_rows': len(chosen), 'replay_scope': scope,
            ...
            fixture.write_json(audit.OUT / 'gru_audit_progress.json', results)
    ...
    fixture.write_json(audit.OUT / 'gru_audit.json', {'status': 'passed', 'source_sha256': fixture.sha256(__file__),
