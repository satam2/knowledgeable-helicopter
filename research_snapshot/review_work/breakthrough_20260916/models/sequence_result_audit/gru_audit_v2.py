...
def main():
    ...
    for fold, month, nextmonth in [('F1', '07', '08'), ('F3', '11', '12')]:
        ...
        for variant in ('static', 'context'):
            ...
            fixture.write_json(audit.OUT / 'gru_audit_v2_progress.json', results)
    ...
    fixture.write_json(audit.OUT / 'gru_audit_v2.json', {'status': 'passed', 'source_sha256': fixture.sha256(__file__),
