...
def main(fold):
    ...
    assert {stage:dict(n=len(part),hash=object_hash(part[ID].tolist())) for stage,part in [('fit',fit),('tune',tune)]}==marker['ids']==binding['fit_ids']
    ...
    out=ROOT/f'private_runs/tail240_20260916/validation/catboost387_result_{fold}_v1';out.mkdir(parents=True,exist_ok=False)
