...
BASE = previous.BASE
OUT = v.ROOT / 'private_runs/tail240_20260916/validation/surface_takeoff_v2'
...
def main():
    ...
    assert protocol['source_sha256'] == v.sha256(v.ROOT / 'review_work/tail240_20260916/forensics/surface_takeoff_join_v1.py')
