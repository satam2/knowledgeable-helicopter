...
def main(fold,producer_root):
    ...
    out=ROOT/'private_runs/tail240_20260916/validation'/('atfm_model_v2_'+root.name+'_'+fold)
    ...
    prediction=model.predict(matrix,num_threads=1)+tune.proxy_sec.to_numpy(float)
