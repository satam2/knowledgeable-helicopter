...
OUT=ROOT/'private_runs/tail240_20260916/validation/atfm_workbooks_v1'
...
def verify():
    ...
    receipt={'status':'passed','source_sha256':sha(__file__),'sample_definition_sha256':sha(OUT/'prepared_samples.json'),
        ...
        'reports':reports,'runtime_sec':time.monotonic()-began,'rss_bytes':psutil.Process().memory_info().rss,
