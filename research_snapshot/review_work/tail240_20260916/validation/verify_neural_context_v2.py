...
def main(fold,version):
    out=ROOT/f'private_runs/tail240_20260916/validation/neural_context_{fold}_{version}_verifier_v2'
    ...
    matrix,vocab,receipts=producer.risk.load_matrix(ids,len(fit),desired,out)
