...
def brute(data,ids):
    events=data.sort_values(ID,kind='stable').drop_duplicates(['airport','month','flightkey','timestamp'])
    output=[]
...
def main():
    ...
    out=ROOT/f'private_runs/tail240_20260916/validation/following_groups_{"cache" if args.cache else "synthetic"}_v1'
