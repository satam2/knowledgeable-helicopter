...
OUT = ROOT / 'private_runs/tail240_20260916/validation/location_impact_v1'
...
def main():
    ...
    fit_hash = __import__('hashlib').sha256(json.dumps(fit[ID].tolist(), sort_keys=True, separators=(',', ':')).encode()).hexdigest()
