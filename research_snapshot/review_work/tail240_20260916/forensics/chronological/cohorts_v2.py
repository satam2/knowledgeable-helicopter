...
DEST = external_path(ROOT / 'private_runs/tail240_20260916/forensics/chronological_cohorts/v2')
...
def main():
    ...
    sources = [Path(__file__), Path(__file__).with_name('cohorts_v1.py'), Path(__file__).with_name('test_cohorts_v2.py'),
