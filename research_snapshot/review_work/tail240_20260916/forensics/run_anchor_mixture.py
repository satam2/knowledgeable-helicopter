...
OUT = ROOT / "private_runs/tail240_20260916/forensics/models/anchor_tune_v1"
...
def declare():
    definition = {"arms":["three_anchor","dst_four_anchor"],"folds":["F1","F3"],"stage":"tune only",
        ...
        "source_sha256":sha256(__file__),"lexical_completion_sha256":sha256(LEXICAL / "completion.json"),"resources":"2CPU6GiB8GiBhostreserve"}
...
def run_fold(fold,x,meta,data):
    ...
    record = {"status":"complete","fold":fold,"split":split,"protocol_sha256":sha256(OUT / "protocol.json"),"previous_lexical_mse":previous_mse,
        "residual":residual_evidence,"reports":reports,"gate_passed":bool(passed),"score_read_or_predicted":False,
