...
import normalized_missing_tune as native_runtime
import numpy as np
import pandas as pd
...
ID=base.ID
OUT=ROOT / "private_runs/tail240_20260916/forensics/models/normalized_lexical_v2"
...
def declare():
    ...
    record={"created_utc":common.utc_now(),"arms":["control76","lexical91"],"lexical_columns":FEATURES,
        ...
        "runtime_fix":"Initialize normalized_missing_tune and nativeLightGBM before numpy/joblib, same verified import-order fix as normalized_missing_refit_v2; no model/data changes.",
        "prior_attempt_protocol_sha256":common.sha256(ROOT / "private_runs/tail240_20260916/forensics/models/normalized_lexical_v1/protocol.json"),
        "runtime_probe_sha256":common.sha256(ROOT / "review_work/tail240_20260916/models/probe_normalized_runtime.py"),
