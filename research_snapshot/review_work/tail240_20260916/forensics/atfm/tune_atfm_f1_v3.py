...
OUT = common.external_path(ROOT / 'private_runs/tail240_20260916/forensics/atfm/tune_f1_v3')
...
if __name__ == '__main__':
    ...
    if args.declare_only:
        declare()
        print('Declared ATFM416 F1 v3 with cached schema discovery and 18 GiB process ceiling; no fit launched', flush=True)
    else:
        assert args.fold
        run(args.fold)
