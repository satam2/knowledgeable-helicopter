...
OUT=ROOT / "private_runs/tail240_20260916/forensics/alias_rotation/models_tune_v2"
...
def declare():
    definition={"arms":ARMS,"scope":"Original fullmissing fit and tune only F1/F3; no refit or scoreprediction",
        ...
        "pilot_manifest_sha256":sha256(PILOT / "manifest.json"),"independent_pilot_receipt_sha256":sha256(ROOT / "private_runs/tail240_20260916/validation/alias_rotation_v2/receipt.json"),"old_opdi_manifest_sha256":sha256(BASE / "manifest.json"),
